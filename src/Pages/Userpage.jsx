            ...
            {activeTab === "overview" && (
              <>
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-xl shadow-orange-900/5 border border-[#f3e0c0] dark:border-slate-800/60">
                  ...
                  <div className="mt-4 p-5 rounded-2xl bg-[#fafafa] dark:bg-slate-800/40 border border-gray-100 dark:border-slate-800/60 flex justify-between items-center">
                    <div>
                    ...
                    <button
                      ...
                      className="text-sm text-[#bc5f13] font-semibold hover:underline cursor-pointer"
                    >
                      Manage
                    </button>
                  </div>
