  ...
  return (
    <div className="bg-[#FCF3E7] dark:bg-slate-950 min-h-screen pt-36 pb-20 text-black dark:text-white">
      <div className="max-w-7xl mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-serif tracking-tight mb-12 border-b border-gray-300/50 pb-4">
          Your Shopping Cart
        </h1>
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    <h3 className="text-xl font-bold uppercase m-0">
                      {item.name}
                    </h3>
                    <p className="text-[#bc5f13] font-bold text-lg mt-1">
                      {item.price}
                    </p>
                  </div>
            ...
            <div className="bg-[#fcf3e7] dark:bg-slate-900 p-6 rounded-2xl flex flex-col justify-between min-h-[280px]">
              <div>
                <h3 className="text-2xl font-serif border-b pb-3 m-0">
                  Order Summary
                </h3>
                <div className="space-y-3 text-sm mt-5">
                  ...
                  <div className="flex justify-between text-xl font-bold pt-4 border-t mt-2">
                    <span>Total</span>
                    <span className="text-[#bc5f13]">${calculateTotal()}</span>
                  </div>
                </div>
              </div>
